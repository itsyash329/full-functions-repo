...
async def make_compact_start_link(client, payload):
    token = await client.mongodb.create_short_start_token(payload)
...
<blockquote>ᴏʀ sᴇɴᴅ ᴛʜᴇ ᴅʙ ᴄʜᴀɴɴᴇʟ ᴘᴏsᴛ ʟɪɴᴋ</blockquote>""",
    ...
    link = await make_compact_start_link(client, base64_string)
